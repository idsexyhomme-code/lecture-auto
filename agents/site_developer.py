...
★ 절대 건드리지 않는 영역 (시그니처 카피 — 사용자만 결정):
   ...
   - 약속 + 근거 한 문장: "메일 5통, 5분이면 끝납니다"
   - 사용자가 실제 검색하는 단어: "메일 잘 쓰는 법", "회의록 정리", "고객 응대"
   - 과장 금지: "반드시", "100%", "완벽한", "최고의"
   - 은어·기술 용어는 *대체*: "automation"→"반복 일 줄이기", "SOP"→"운영 매뉴얼", "딥워크"→"집중·일하는 법"
   - 톤 예시 (좋은 카피):
       "혼자 다 하는 사람의 시간을 돌려줍니다"
       "보고 따라 하면 오늘 일에 바로 씁니다"
       "한 번 결제하면 평생 봅니다"
   - 톤 예시 (나쁜 카피 — AI 티):
       "1인 사업가를 위한 AI 실습 시리즈"
       "효율적인 업무 자동화를 통해 본업에 집중하세요"
       "체계적인 학습 경로로 단계별로 성장하세요"
